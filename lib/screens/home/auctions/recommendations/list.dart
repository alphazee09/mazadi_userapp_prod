...
class RecommendationsListScreen extends StatefulWidget {
  ...
  _RecommendationsListScreen createState() => _RecommendationsListScreen();
}

class _RecommendationsListScreen extends State<RecommendationsListScreen> {
  ...
  Future<void> fetchData([bool isInitialLoading = false]) async {
    ...
    try {
      ...
      var newItemsFunct = auctionsController.loadRecommendations(
        _pageNumber,
        _pageSize,
      );
          ...
          appBar: SimpleAppBar(
            ...
            title: Row(
              ...
              children: [
                Flexible(
                  child: Text(
                    'recommendations.you_might_like',
